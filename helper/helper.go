...
func ExecWithSK(sk *slhdsa.PrivateKey, addr common.Address, data []byte, blobs bool) *types.Transaction {
	cl, _ := GetRealBackend()
...
func GetRealBackend() (*rpc.Client, *slhdsa.PrivateKey) {
	// eth.sendTransaction({from:personal.listAccounts[0], to:"0xb02A2EdA1b317FBd16760128836B0Ac59B560e9D", value: "100000000000000"})

	sk := crypto.ToSLHDSAUnsafe(common.FromHex(txfuzz.SK))
